      ...
      <div className="admin-user-section-grid">
        <section className="admin-user-section admin-settings-section">
          <div className="admin-user-section-head">
            ...
            <span>Firestore: appSettings / commerce</span>
          </div>
        ...
        <section className="admin-user-section">
          <div className="admin-user-section-head">
            <h3>Ghi chú dữ liệu địa giới</h3>
            <span>Nguồn local JSON</span>
          </div>

          <div style={{ display: "grid", gap: "12px" }}>
            <div style={{ padding: "14px 16px", borderRadius: "12px", background: "#f8fafc", color: "#334155", lineHeight: 1.6 }}>
              File hiện có 34 tỉnh / thành và mỗi tỉnh chứa trực tiếp danh sách phường / xã trong trường `Wards`.
            </div>
            <div style={{ padding: "14px 16px", borderRadius: "12px", background: "#f8fafc", color: "#334155", lineHeight: 1.6 }}>
              Dataset được cung cấp không có mảng `Districts` riêng, nên màn này sẽ hiển thị đúng theo dữ liệu thật để tránh sai cấu trúc.
            </div>
            <div style={{ padding: "14px 16px", borderRadius: "12px", background: "#f8fafc", color: "#334155", lineHeight: 1.6 }}>
              Nếu sau này mình có file địa giới 3 tầng mới hơn, em có thể nối tiếp vào màn này mà không cần hardcode lại form.
            </div>
          </div>
        </section>
      </div>
