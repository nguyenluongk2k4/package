        ...
        <section className="admin-dashboard-main-grid">
          <article className="admin-dashboard-feature-card">
            ...
            <div>
              ...
              <h2>Cố đô Hoa Lư đang là điểm nhấn trong hành trình AR và check-in</h2>
              <Link href="/admin/ar-characters">Xem quản lý AR</Link>
            </div>
          </article>

          <aside className="admin-dashboard-activity-card">
            <header>
              <h2>Phân hệ ưu tiên</h2>
            ...
            <div className="admin-activity-list">
              <article>
                ...
                <div>
                  ...
                  <p>Theo dõi tiến trình hộ chiếu, check-in, lịch sử quét AR và trạng thái kích hoạt tài khoản.</p>
                </div>
              </article>
              <article>
                <span />
                <div>
                  ...
                  <p>Theo dõi dòng tiền, cập nhật trạng thái giao nhận và quản lý đối soát chuyển khoản SePay.</p>
                </div>
              </article>
              <article>
                <span />
                <div>
                  <strong>Mã kích hoạt & AR</strong>
                  <p>Cập nhật mã QR kích hoạt hộ chiếu vật lý và điều chỉnh tương tác nhân vật 3D.</p>
                </div>
              </article>
            </div>
            <button type="button">Xem lộ trình</button>
          </aside>
        </section>
      </div>
    </AdminLayout>
