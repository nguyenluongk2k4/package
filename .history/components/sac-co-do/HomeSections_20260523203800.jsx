        ...
        <div className="relative md:rounded-6xl rounded-3xl overflow-hidden">
          <div className="lg:h-120 sm:h-150 h-125 bg-black overflow-hidden relative">
            ...
            <div className="relative z-3 h-full flex items-center justify-center text-center px-5">
              <div>
                <h2 className="!font-display lg:!text-80 sm:!text-60 !text-40 !text-white mb-5">
    ...
    <div className="bg-white md:pt-30 pt-17.5 relative overflow-hidden">
      ...
      <div className="container">
        <div className="section-content">
          ...
          <div className="overflow-hidden rounded-br-25xl rounded-bl-25xl bg-primary pt-27.5 pb-17.5 bg-[url(../images/w-cho-top.png),url(../images/w-cho-btm.png)] bg-no-repeat [background-position:top_left,bottom_left] flex flex-wrap items-center justify-between mb-3">
